...
5. **Simulation engine migration to `simcyto` (issues #288/#289 / umbrella #271)**:
   ...
   `functionsForBenchmarking-Cyt.R`. StimGate scientific scenario calculations,
   downstream comparison orchestration, and method evaluations remain StimGate-side
   under `scripts/r/`.
