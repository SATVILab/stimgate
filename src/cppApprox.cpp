/*
 * Provenance: Derived from FAUST (https://github.com/RGLab/FAUST, cppApprox.cpp).
 * Restricted port of base R function approx.
 ...
 *
 *
 *cppApprox is a restricted port of the base R function approx.
