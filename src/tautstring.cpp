/*
 * Provenance: Derived from FAUST (https://github.com/RGLab/FAUST, tautstring.cpp).
 * Originally ported from R package ftnonpar 0.1-88 (strings.c).
 ...
 *I believe that makes it a derived work according to GPL-3.
 *The original work is found in version 0.1-88 of that package.
 *The maintainer of that library, Arne Kovac <A.Kovac at bristol.ac.uk>, is not affiliated with this package.
 *Minor changes have been made for use within faust.
