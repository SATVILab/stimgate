...
#'       deemed 'high'.}
#'     \item{cps_scp}{numeric vector. Values at which the changepoint for
#'       probability of positivity in the cut channel is to be checked. Default
#'       is 90.}
